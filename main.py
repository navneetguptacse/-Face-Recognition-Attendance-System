...
firebase_admin.initialize_app(cred, {
    ...
    'storageBucket': "facerecognitionrealtimeatdsys.appspot.com"
})
...
# Importing the mode images into a list 'imgModeList'
    ...
    if faceCurFrame:
        for encodeFace,faceLoc in zip(encodeCurFrame,faceCurFrame):
            ...
            if matches[matcheIndex]:
                ...
                if counter == 0:
                    cvzone.putTextRect(imgBackground,'Loading',(275,400),2)
